...
class nozzleFda:
    def __init__(self):
        ...
        self.create_cylinder(z[0], z[1], radius[0], 'cylinder1-master', 'inlet', start_size=size_big, end_size=size_small)
        self.create_nozzle('nozzle-master', 'cylinder1-slave', core_size=0.12)
        self.create_cylinder(z[2], z[3], radius[1], 'cylinder2-master', 'nozzle-slave', core_size=0.1, start_size=size_small, end_size=size_small)
        self.create_cylinder(z[3], z[4], radius[0], 'outlet', 'cylinder2-slave', start_size=size_small, end_size=size_big)
    ...
    def create_cylinder(self, z1, z2, r, patch_top, patch_bottom, bl_thickness=bl_thickness_def, core_size=core_size_def, start_size=size_small, end_size=size_small):
        ...
        cylinder.chop_axial(start_size=start_size, end_size=end_size)
    ...
    def create_nozzle(self, patch_top, patch_bottom, bl_thickness=bl_thickness_def, core_size=core_size_def, start_size=size_small, end_size=size_small):
        z1 = self.z[1]
        z2 = self.z[2]
        r1 = self.radius[0]
        r2 = self.radius[1]
        ...
        nozzle.chop_axial(start_size=start_size, end_size=end_size)
